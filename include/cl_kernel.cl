...
__kernel void gather_kernel(__global int32_t *indices,
                            __global struct read_core_t *d_cores_in,
                            __global struct read_core_t *d_reads_core,
                            uint64_t numOfRead)
{
...
__kernel void gpu_assign_read_ASE_kernel(
    ...
    __global uint64_t *d_reads_end_, __global uint8_t *d_reads_strand,
    __global struct read_core_t *d_reads_core, int32_t numOfRead,
    __global Assist *d_assist, __global struct ASECounter *ACT)
{
...
__kernel void gpu_count_PSI(__global uint64_t *d_ases_start_,
                            ...
                            __global struct ase_core_t *d_ases_core,
